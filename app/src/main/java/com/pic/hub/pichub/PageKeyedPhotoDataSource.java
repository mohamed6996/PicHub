...
//        Call<PhotoList> photoList = apiInterface.searchPhotos(1, params.requestedLoadSize,"flower");
//        try {
...
//        Call<PhotoList> photoList = apiInterface.searchPhotos(params.key, params.requestedLoadSize,"flower");
//        try {
//            Response<PhotoList> response = photoList.execute();
//            if (response.isSuccessful()) {
//                int adjacentKey = 0;
